...
export default function PlayersPage() {
    return (
        <div className="h-screen bg-[#09090b] text-white font-sans selection:bg-purple-500/30 flex flex-col overflow-hidden">
            {/* Unified Navbar (Fixed Height) */}
            <div className="flex-shrink-0">
                <Navbar activeTab='results' />
            </div>

            <div className="flex-1 flex flex-col pt-24 px-4 max-w-6xl mx-auto w-full pb-4 overflow-hidden">
                ...
                {/* RankingList takes all remaining space */}
