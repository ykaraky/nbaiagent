...
import { LayoutDashboard, Calendar, History, Menu, X } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <div className={`transition-all duration-300 ${isScrolled ? "scale-90" : "scale-100"}`}>
                        <h1 className="text-2xl md:text-3xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600">
                            NBAiAGENT
                        </h1>
                    </div>
                </div>
                ...
                <nav className="hidden md:flex items-center gap-1 bg-gray-900/50 p-1 rounded-xl border border-gray-800/50 backdrop-blur-sm">
                    ...
                    <Link
                        href="/dashboard"
                        className="flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-wider text-gray-400 hover:text-white hover:bg-gray-800/50 transition-all duration-300"
                    >
